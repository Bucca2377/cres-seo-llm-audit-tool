...
- OFFICE HOURS = CONSISTENCY CHECK. Compare the hours across platforms day by day. If they DIFFER (different open/close times) or any platform shows broken hours (e.g. "Sunday 12 AM to 12 AM"), mark the conflicting/broken cells AMBER and state the exact discrepancy in the note. Only mark hours GREEN when they MATCH across the platforms that list them. Conflicting or broken hours are NEVER green.

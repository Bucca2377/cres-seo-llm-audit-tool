...
Status values are exactly "green" (found & functional / consistent), "amber" (present but could not verify / could not render — NOT for data that simply differs), "red" (confirmed absent OR a confirmed conflict across platforms, e.g. hours that genuinely do not match), or "na" (not applicable to that platform).

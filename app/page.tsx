...
- OFFICE HOURS = CONSISTENCY CHECK. Compare the hours across platforms day by day. If they differ, or a platform lists a day as "12 AM to 12 AM" (which displays as open 24 hours and is almost always a data-entry mistake), mark the affected cells AMBER and explain it in PLAIN ENGLISH a property manager understands. Examples of good notes: "Google shows weekdays starting at 10 AM, but the website and Apartments.com show 9 AM" or "the website lists Sunday as open 24 hours (12 AM to 12 AM), which looks like a data-entry error since the office is closed Sunday on Google and Apartments.com". NEVER use jargon like "structurally invalid", "broken 24-hour display", or "broken entry". Only mark hours GREEN when they match across the platforms that list them.
